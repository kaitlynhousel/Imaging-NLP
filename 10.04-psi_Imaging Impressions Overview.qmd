...
library(discrim)
library(tidymodels)
imaging <- read.csv("S:/Sepsis-ALI/Data Management/MESSI/repository/data/raw/2024/SR8658598 - MESSI Study, IMPRESSION.csv")
...
```{r}
#| warning: false
time_zero <- readRDS("S:/Sepsis-ALI/Data Management/MESSI/repository/analytic files/2023/messi_demographic_time_zero_230815")
enroll_key <- readRDS("S:/Sepsis-ALI/Data Management/MESSI/repository/analytic files/2023/messi_enroll_key_230815")
...
saveRDS(fitted_lasso, "S:/Sepsis-ALI/Data Management/MESSI/xx-archive-projects/NLP imaging impressions/pleural_effusion_fitted_model")
```
